...
<p align="center">
  <i>No Shell. Just Intelligence.</i>
</p>
...
<p align="center">
  <b>A pure Python API for retrieving YouTube transcripts. No selenium. No headless browser. Just direct access to YouTube's InnerTube API — the octopus way: no shell, just raw capability.</b>
</p>
<p align="center">
...
This code uses an undocumented part of the YouTube API (InnerTube). Like the octopus adapting to changing tides, this API adapts to YouTube's changes. If something breaks, I'll fix it fast. No shell means no retreat — we evolve.  
