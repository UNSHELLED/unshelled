...
| **Research** | [`research/`](research/) — Active exploration and findings |
| **Archive** | [`archive/`](archive/) — Historical record |
| **Specifications** | [`specs/`](specs/) — Product specifications |
...
1. **Understand the philosophy:** Read [`UNSHELLED/protocol/soul.md`](UNSHELLED/protocol/soul.md)
2. **Learn the Pact:** Read [`UNSHELLED/protocol/pact.md`](UNSHELLED/protocol/pact.md)
3. **Meet the crew:** Explore [`ven0m/crew/`](ven0m/crew/)
4. **See VENOM in action:** Review [`ven0m/`](ven0m/)
5. **Build with VENOCTIS:** See [`venoctis/ARCHITECTURE.md`](venoctis/ARCHITECTURE.md)
