...
| `venom-explorer.md` | `@venom-explorer` | Scout | Fast anatomy scan — shape, entry points, callers, manifest. Haiku model. | Yes | No fast pre-flight — researcher goes in blind |
