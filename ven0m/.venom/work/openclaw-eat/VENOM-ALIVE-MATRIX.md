...
| **VENOM bundle (in-tree)** | `openclaw-main/docs/reference/templates/venom/` | Disposition + skills; `pnpm apply-venom-workspace` — see `openclaw-main/VENOM.md` **Innovation model** |
