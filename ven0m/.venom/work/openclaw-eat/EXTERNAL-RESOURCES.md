...
| **OpenAPI (docs URL)** | https://docs.openclaw.ai/api-reference/openapi.json | **Caveat (2026-04-01):** response is Mintlify **sample**, not OpenClaw. **Gateway contract** = WebSocket JSON — [Gateway Protocol](https://docs.openclaw.ai/gateway/protocol.md) + [`09-source/11-protocol.md`](./09-source/11-protocol.md) |
