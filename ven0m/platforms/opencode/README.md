...
├── SPEC.md                          ← Constitution: methodology + non-negotiables
├── MATRIX.md                        ← OpenCode × Cursor × Claude — injection + verify
├── ARENA.md                         ← Drill floor: stress rounds + proof after changes
...
**Governance:** main-repo **`anatomy/`** (`PARTS.md` = each body file’s job, `SPAWN.md` = birth checklist) · `SPEC.md` (how we decide and align, this platform) · `MATRIX.md` (where each tool loads VENOM) · `template/VENOM.md` (soul). Operational depth stays in this README and `MANIFEST.md`.
